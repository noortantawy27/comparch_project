...
force -freeze sim:/processor/FetchMem_comp/memory/memory(4) b\"00111010010000000000000000000000" 0
force -freeze sim:/processor/FetchMem_comp/memory/memory(5) b\"10111011000000000000000000010100" 0
force -freeze sim:/processor/FetchMem_comp/memory/memory(6) b\"10111100000000000000000000011000" 0
force -freeze sim:/processor/FetchMem_comp/memory/memory(7) b\"00111111111000000000000000000000" 0
force -freeze sim:/processor/FetchMem_comp/memory/memory(8) b\"10101000000010000000000000000000" 0
force -freeze sim:/processor/FetchMem_comp/memory/memory(9) b\"00111010010000000000000000000000" 0
force -freeze sim:/processor/FetchMem_comp/memory/memory(10) b\"00111110110000000000000000000000" 0
force -freeze sim:/processor/FetchMem_comp/memory/memory(11) b\"10111001000000000000000110010000" 0
force -freeze sim:/processor/FetchMem_comp/memory/memory(12) b\"01001100100011000000000000000000" 0
run
run
run
run
